...
<div className="w-full max-w-[1440px] mx-auto grid grid-cols-3 gap-8 sm:grid-cols-3 md:grid-cols-5 lg:max-w-[1440px] text-gray-500 font-semibold">
  ...
  <div className="flex flex-col items-center">
    <img src={javaScriptIcon} alt="Fifth Icon" className="w-auto h-auto" />
  ...
  <div className="flex flex-col items-center">
    <img src={typescriptIcon} alt="Fifth Icon" className="w-auto h-auto" />
  ...
  <div className="flex flex-col items-center">
    <img src={pythonIcon} alt="Fifth Icon" className="w-[74px] h-[66px]" />
  ...
  <div className="flex flex-col items-center">
    <img src={githubIcon} alt="Fifth Icon" className="w-[74px] h-[66px]" />
